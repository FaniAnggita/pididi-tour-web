...
<head>
    ...
    <!-- SEO Title & Meta Tags -->
    <title>@yield('title', 'Vayana Wisata | Paket Wisata Jogja, Bali & Phinisi Komodo Otentik')</title>
    <meta name="description" content="@yield('meta_description', 'Vayana Wisata adalah penyedia pengalaman perjalanan otentik di Indonesia. Lebih dari Sekadar Perjalanan dengan curated trip, village life, dan bespoke travel experience.')">
    <meta name="keywords" content="@yield('meta_keywords', 'Vayana Wisata, Paket Wisata Jogja, Tour Bali Otentik, Sailing Phinisi Komodo, Custom Trip Indonesia, Village Experience')">
    ...
    <meta property="og:title" content="@yield('og_title', 'Vayana Wisata - Lebih dari Sekadar Perjalanan')">
    <meta property="og:description" content="@yield('og_description', 'Pengalaman perjalanan otentik berbasis budaya dan pemberdayaan masyarakat lokal di Indonesia.')">
    <meta property="og:image" content="@yield('og_image', asset('vayana_with_tagline.png'))">
    <meta property="og:site_name" content="Vayana Wisata">
    <meta property="og:locale" content="id_ID">

    <!-- Twitter Cards -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="{{ url()->current() }}">
    <meta name="twitter:title" content="@yield('og_title', 'Vayana Wisata - Lebih dari Sekadar Perjalanan')">
    <meta name="twitter:description" content="@yield('og_description', 'Pengalaman perjalanan otentik berbasis budaya dan pemberdayaan masyarakat lokal di Indonesia.')">
    <meta name="twitter:image" content="@yield('og_image', asset('vayana_with_tagline.png'))">

    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('vayana_logo_no_tagline.png') }}">
    ...
    <!-- Schema.org JSON-LD Structured Data: TravelAgency -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "TravelAgency",
      "name": "Vayana Wisata",
      "legalName": "PT VAYANA WISATA INDONESIA",
      "url": "{{ url('/') }}",
      "logo": "{{ asset('vayana_with_tagline.png') }}",
      "image": "{{ asset('vayana_with_tagline.png') }}",
      "description": "Vayana Wisata adalah penyedia pengalaman perjalanan otentik di Indonesia.",
      "telephone": "+6282231872974",
      "email": "hello@vayanawisata.com",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "Bulus Wetan, Sumber Agung, Jetis",
...
<body
    class="bg-brand-cream text-brand-navy font-sans min-h-screen flex flex-col antialiased selection:bg-brand-orange selection:text-white">
    ...
    <header x-data="{ mobileMenuOpen: false, scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 20)"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center">
                    <a href="https://wa.me/6282231872974?text=Halo%20Vayana%20Wisata,%20saya%20ingin%20konsultasi%20paket%20wisata"
                        target="_blank"
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="flex flex-col space-y-2">
                ...
                <a href="{{ route('tours') }}" @click="mobileMenuOpen = false"
    ...
    <footer class="bg-brand-navy text-white relative mt-20 pt-16 pb-12 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-5 space-y-5">
                    ...
                    <p class="text-gray-300 text-sm leading-relaxed max-w-md pt-1">
                        Lebih dari Sekadar Perjalanan. Vayana Wisata menciptakan pengalaman perjalanan otentik yang
                        menghubungkan Anda dengan keindahan alam, budaya lokal, dan cerita bermakna di seluruh
                        nusantara.
                    </p>
                    <div class="flex items-center space-x-3 pt-2">
                        <a href="https://instagram.com" target="_blank" aria-label="Instagram"
                            class="w-10 h-10 rounded-xl bg-white/10 hover:bg-brand-orange flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-orange-500/30">
                ...
                <div class="lg:col-span-3 space-y-4">
                    <h3
                        class="text-base font-black text-amber-300 border-b border-white/10 pb-2.5 tracking-wider uppercase">
                        Jelajahi Vayana</h3>
                    <ul class="space-y-2.5 text-sm text-gray-300">
                        <li><a href="{{ route('home') }}"
                                class="hover:text-brand-orange transition-colors flex items-center gap-2.5"><i
                                    class="fa-solid fa-chevron-right text-xs text-brand-orange"></i> Beranda</a></li>
                        <li><a href="{{ route('about') }}"
                                class="hover:text-brand-orange transition-colors flex items-center gap-2.5"><i
                                    class="fa-solid fa-chevron-right text-xs text-brand-orange"></i> Tentang Kami</a>
                        </li>
                        <li><a href="{{ route('tours') }}"
                                class="hover:text-brand-orange transition-colors flex items-center gap-2.5"><i
                                    class="fa-solid fa-chevron-right text-xs text-brand-orange"></i> Curated
                                Experience</a></li>
                        <li><a href="{{ route('tours') }}#bespoke"
                                class="hover:text-brand-orange transition-colors flex items-center gap-2.5"><i
                                    class="fa-solid fa-chevron-right text-xs text-brand-orange"></i> Bespoke Trip
                                (Custom)</a></li>
                        <li><a href="{{ route('blog') }}"
                                class="hover:text-brand-orange transition-colors flex items-center gap-2.5"><i
                                    class="fa-solid fa-chevron-right text-xs text-brand-orange"></i> Jurnal
                                Perjalanan</a></li>
                        <li><a href="{{ route('testimonials') }}"
                                class="hover:text-brand-orange transition-colors flex items-center gap-2.5"><i
                                    class="fa-solid fa-chevron-right text-xs text-brand-orange"></i> Ulasan Tamu</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="lg:col-span-4 space-y-4">
                    <h3
                        ...
                        Hubungi Kami</h3>
                    <div
                        class="bg-white/5 backdrop-blur-md p-5 rounded-3xl border border-white/10 space-y-3 text-xs text-gray-300 shadow-xl">
                        <div class="flex items-start gap-3">
                            <div
                                class="w-7 h-7 rounded-lg bg-brand-orange/20 flex items-center justify-center text-brand-orange shrink-0 mt-0.5">
                                <i class="fa-solid fa-location-dot"></i>
                            </div>
                            <span> Bulus Wetan, Sumber Agung,
                                Jetis, Bantul, D.I. Yogyakarta</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div
                                class="w-7 h-7 rounded-lg bg-brand-orange/20 flex items-center justify-center text-brand-orange shrink-0">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span>hello@vayanawisata.com</span>
                        </div>
                        <div
                            class="flex items-center gap-3 text-emerald-400 font-semibold pt-1 border-t border-white/10">
            ...
            <!-- Bottom Copyright -->
            <div
                class="mt-12 pt-8 border-t border-white/10 text-center text-xs text-gray-400 flex flex-col md:flex-row items-center justify-between gap-4">
                <p>&copy; {{ date('Y') }} <strong>Vayana Wisata</strong>. All rights reserved. Made with <i
                        class="fa-solid fa-heart text-rose-500 mx-1"></i> for Travel Around Indonesia.</p>
    ...
    <a href="https://wa.me/6282231872974?text=Halo%20Vayana%20Wisata,%20saya%20ingin%20tanya%20paket%20wisata!" target="_blank"
        aria-label="Chat WhatsApp Vayana Wisata"
        ...
        <!-- Tooltip Badge -->
        <span
            class="absolute right-full mr-3 bg-brand-navy text-white text-xs font-bold px-3 py-1.5 rounded-xl shadow-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none border border-emerald-400/30 flex items-center gap-1.5">
            <i class="fa-solid fa-comments text-emerald-400"></i> Tanya Tim Vayana!
        </span>
    </a>
